...
class Garden {
  ...
  @override
  String toString() {
    return 'Garden($id, $name, $pump, $sunFollow, $lights, $rgb, $temperature, $humidity, $lightIntensity, $solarVoltage, $batteryVoltage, $pumpSchedule, $lightSchedule, $gardenToken, $lastOnline)';
  }
}
